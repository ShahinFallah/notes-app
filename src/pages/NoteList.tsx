    ...
    <>
      <div className="flex flex-col text-text-200">
        <div className="flex justify-between items-center text-white border-b border-bg-300 pb-3 mb-3">
          ...
          <div className="space-x-2">
            ...
            <button
              ...
              className="border border-bg-300 text-text-200 p-1 px-1.5 rounded-md hover:rounded-md"
            >
              Edit Tags
            </button>
          </div>
        ...
        <div className="flex gap-3 mb-7">
          ...
          <div className="flex flex-col flex-1 gap-1">
            <label htmlFor="tag" className="text-text-200">
              tags
            </label>
            <ReactSelect
              isMulti
        ...
        {notes.length !== 0 ? (
          ...
          <h1 className="text-center text-2xl mt-2 font-semibold text-text-200">
            There are no notes!
          </h1>
        )}
      </div>
